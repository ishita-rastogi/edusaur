...
$string['enrolledusers'] = 'Enrollled users';
...
$string['extremovedaction_help'] = 'Select action to carry out when user enrollment disappears from external enrolment source. Please note that some user data and settings are purged from course during course unenrolment.';
