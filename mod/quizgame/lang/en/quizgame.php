...
$string['eventgamestarted'] = 'Meteor Fall game started';
$string['eventgamescoreadded'] = 'Meteor Fall score recorded';
$string['eventgamescoresviewed'] = 'Meteor Fall scores viewed';
...
Meteor Fall is an activity module that loads quiz questions from the course it\'s added to. The possible answers come down as space ships and you have to shoot the correct one.

**Note**: Meteor Fall is designed to promote learning rather than for assessment. Students will have infinite attempts with instant feedback. For this reason, only add questions you want students to learn the answer to, rather than questions you want to assess if they have learned';
$string['modulenameplural'] = 'Meteor Fall games';
$string['modulename'] = 'Meteor Fall';
...
$string['pluginadministration'] = 'Meteor Fall administration';
$string['pluginname'] = 'Meteor Fall';
...
$string['quizgamename_help'] = 'What is the name of this Meteor Fall?';
$string['quizgamename'] = 'Meteor Fall name';
$string['quizgame'] = 'Meteor Fall';
$string['quizgame:addinstance'] = 'Add a Meteor Fall instance';
$string['quizgame:view'] = 'View Meteor Fall';
